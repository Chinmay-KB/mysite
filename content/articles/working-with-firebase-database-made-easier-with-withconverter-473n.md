---
title: "Working with Firebase Cloud Firestore made easier with \"withConverter()\""
date: 2021-06-28
tags: "flutter, firebase, dart, serialization"
canonical: https://dev.to/chinmaykb/working-with-firebase-database-made-easier-with-withconverter-473n
cover: https://media2.dev.to/dynamic/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fvrsxu5jpy27by0n7khd2.jpg
description: "Disclaimer - This article is not about how to set up cloud firestore. firebase.flutter.dev is a good..."
---

> Disclaimer - This article is not about how to set up cloud firestore. [firebase.flutter.dev](https://firebase.flutter.dev/) is a good place to learn about that. This article is about an issue I face personally while using Firebase Cloud Firestore, and what I do to make life a little easier!

## The Problem

Assuming you are a Flutter developer, you love dart for being strongly typed. But when we are dealing with Firebase Cloud Firestore, it returns a `Map<String, dynamic>` object. There are quite a few downsides to it.
...
I have set up a firebase cloud firestore with a single document, with fairly nested data.
