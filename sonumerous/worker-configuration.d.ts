/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: fad0e7d6316a301a799aab035b5dd595)
...
interface __BaseEnv_Env {
	...
	LOCAL_DEV: "false";
	GENERATE: Workflow<Parameters<import("./worker/index").GenerationWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_DOMAIN" | "ACCESS_AUD" | "LOCAL_DEV">> {}
}
